...
Shared by the CLI, Streamlit frontend, and any other API consumer.
"""
...
class AegraClient:
    ...
    def get_download_url(
        ...
        return (
            f"{self.base_url}/threads/{thread_id}/files/download"
            f"?session_id={session_id}&path={encoded_path}"
        )
